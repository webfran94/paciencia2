    ...
    <div className="space-y-6 pb-12">
      ...
      <div className={`p-10 rounded-[3rem] border-2 shadow-sm transition-all ${level > 7 ? 'bg-red-50 border-red-200' : 'bg-white border-slate-100'}`}>
        ...
        <p className="text-xs text-slate-500 text-center italic leading-relaxed px-4">
          "Aprende qué sentimientos en tu cuerpo provocan que tu sistema se sobrecargue."
        </p>
      </div>

      <button onClick={save} className="w-full py-5 bg-orange-600 text-white rounded-[2rem] font-black uppercase tracking-widest shadow-xl shadow-orange-100 active:scale-95 transition-all">Guardar Mapa</button>
    </div>
  );
};
